...
const AgencySettings = () => {
    ...
    const sections = [
        ...
        { id: 'marketing',     name: 'Bulk Marketing',       icon: Send,          description: 'Send bulk WhatsApp campaign messages to target leads.' },
        ...
        <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0">
                <div className="dash-panel">
                    ...
                    {activeSection !== 'sequences' && activeSection !== 'integrations' && activeSection !== 'marketing' && (
